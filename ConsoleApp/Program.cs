...
public class Program
{
    public static void Main()
    {
        ...
        var path =  "C:\\Users\\hytf2\\Downloads\\bigtest.nbt";
        var result = StringNbt.Parse(input,true);
        //CompoundTag? result = NbtFile.Read(path,FormatOptions.Java, CompressionType.GZip);
        Console.WriteLine(result.ToWarppedString());
        
        //File.WriteAllText(".\\output.json",result.Stringify(true));
    }
}
